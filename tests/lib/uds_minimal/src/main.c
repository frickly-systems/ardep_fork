...
UDSErr_t test_read_memory_uds_callback(struct iso14229_zephyr_instance *inst,
                                       UDSEvent_t event,
                                       void *arg,
                                       void *user_context) {
...
ZTEST_F(lib_uds_minimal, test_read_memory) {
  ...
  test_uds_callback_fake.custom_fake = test_read_memory_uds_callback;
